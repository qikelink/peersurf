...
const mockTalentData = [
  { id: 1, rank: 1, name: "Alex Chen", username: "@alexchen", avatar: "https://github.com/shadcn.png", totalEarnings: 15420, projectsCompleted: 23, successRate: 98, tier: "Diamond", tierColor: "from-blue-500 to-purple-600" },
  { id: 2, rank: 2, name: "Sarah Kim", username: "@sarahkim", avatar: "https://github.com/shadcn.png", totalEarnings: 12850, projectsCompleted: 19, successRate: 95, tier: "Platinum", tierColor: "from-gray-400 to-gray-600" },
  { id: 3, rank: 3, name: "Mike Johnson", username: "@mikej", avatar: "https://github.com/shadcn.png", totalEarnings: 11200, projectsCompleted: 17, successRate: 92, tier: "Gold", tierColor: "from-yellow-500 to-orange-500" },
  { id: 4, rank: 4, name: "Emma Rodriguez", username: "@emmar", avatar: "https://github.com/shadcn.png", totalEarnings: 9850, projectsCompleted: 15, successRate: 88, tier: "Gold", tierColor: "from-yellow-500 to-orange-500" },
  { id: 5, rank: 5, name: "David Park", username: "@davidp", avatar: "https://github.com/shadcn.png", totalEarnings: 8750, projectsCompleted: 14, successRate: 85, tier: "Silver", tierColor: "from-gray-300 to-gray-500" },
  { id: 6, rank: 6, name: "Lisa Wang", username: "@lisaw", avatar: "https://github.com/shadcn.png", totalEarnings: 7200, projectsCompleted: 12, successRate: 90, tier: "Silver", tierColor: "from-gray-300 to-gray-500" },
  { id: 7, rank: 7, name: "James Wilson", username: "@jamesw", avatar: "https://github.com/shadcn.png", totalEarnings: 6800, projectsCompleted: 11, successRate: 87, tier: "Silver", tierColor: "from-gray-300 to-gray-500" },
  { id: 8, rank: 8, name: "Maria Garcia", username: "@mariag", avatar: "https://github.com/shadcn.png", totalEarnings: 6200, projectsCompleted: 10, successRate: 83, tier: "Bronze", tierColor: "from-amber-600 to-amber-800" },
  { id: 9, rank: 9, name: "Tom Brown", username: "@tomb", avatar: "https://github.com/shadcn.png", totalEarnings: 5800, projectsCompleted: 9, successRate: 89, tier: "Bronze", tierColor: "from-amber-600 to-amber-800" },
  { id: 10, rank: 10, name: "Anna Lee", username: "@annal", avatar: "https://github.com/shadcn.png", totalEarnings: 5400, projectsCompleted: 8, successRate: 86, tier: "Bronze", tierColor: "from-amber-600 to-amber-800" }
];
    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="flex flex-col gap-3 md:gap-4 mb-4 md:mb-6" >
          ...
          {/* Tier Filters - Always Visible on Mobile */}
