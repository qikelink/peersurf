...
const Navbar = () => {
  ...
  return (
    <nav className="w-full border-b border-border text-foreground sticky top-0 z-[110] bg-background/95 backdrop-blur-xl supports-[backdrop-filter]:bg-background/80">
